...
//        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_user_version_ios'], [
            'value' => $request['app_user_version_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_user_version_android'], [
            'value' => $request['app_user_version_android']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_merchant_version_ios'], [
            'value' => $request['app_merchant_version_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_merchant_version_android'], [
            'value' => $request['app_merchant_version_android']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_delivery_man_version_ios'], [
            'value' => $request['app_delivery_man_version_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_delivery_man_version_android'], [
            'value' => $request['app_delivery_man_version_android']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'app_user_url_ios'], [
            'value' => $request['app_user_url_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_user_url_android'], [
            'value' => $request['app_user_url_android']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_merchant_url_ios'], [
            'value' => $request['app_merchant_url_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_merchant_url_android'], [
            'value' => $request['app_merchant_url_android']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'app_delivery_man_url_ios'], [
            'value' => $request['app_delivery_man_url_ios']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'app_delivery_man_url_android'], [
            'value' => $request['app_delivery_man_url_android']
        ]);

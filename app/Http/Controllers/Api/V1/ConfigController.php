...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        $key = [
            ...
            'app_user_version_ios', 'app_user_version_android', 'app_merchant_version_ios', 'app_merchant_version_android', 'app_delivery_man_version_ios', 'app_delivery_man_version_android',
            'app_user_url_ios', 'app_user_url_android', 'app_merchant_url_ios', 'app_merchant_url_android', 'app_delivery_man_url_ios', 'app_delivery_man_url_android',
...
//            'app_url_ios' => $settings['app_url_ios'],
            'app_user_version_ios' => $settings['app_user_version_ios'],
            'app_user_version_android' => $settings['app_user_version_android'],
            'app_merchant_version_ios' => $settings['app_merchant_version_ios'],
            'app_merchant_version_android' => $settings['app_merchant_version_android'],
            'app_user_url_ios' => $settings['app_user_url_ios'],
            'app_user_url_android' => $settings['app_user_url_android'],
            'app_merchant_url_ios' => $settings['app_merchant_url_ios'],
            'app_merchant_url_android' => $settings['app_merchant_url_android'],
            'app_delivery_man_version_ios'=>$settings['app_delivery_man_version_ios'],
            'app_delivery_man_version_android' =>$settings['app_delivery_man_version_android'],
            'app_delivery_man_url_ios' => $settings['app_delivery_man_url_ios'],
            'app_delivery_man_url_android' => $settings['app_delivery_man_url_android'],

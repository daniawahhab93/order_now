                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        <div class="order-invoice-left">
                            <h1 class="page-header-title mt-2">
                                <span
                                    class="font--max-sm">{{ translate('messages.order') }} {{translate('id')}} {{translate('#')}}{{ $order['id'] }}</span>
                                <!-- Static -->
                            ...
                            <!-- Static -->
                                <div
                                    class="d-sm-none d-flex flex-wrap ml-auto align-items-center justify-content-end initial-39-2">
                                    @if (!$subscription && !$editing && in_array($order->order_status, ['pending', 'confirmed', 'processing', 'accepted']))
                                        @if ($order->restaurant)
                                            <button class="btn bn--primary btn-outline-primary m-1 print--btn"
                                                    type="button" onclick="edit_order()">
                                                <i class="tio-edit"></i>
                                                <span>{{ translate('messages.edit') }} {{ translate('messages.order') }}</span>
                                            </button>
                                        @endif
                                    @endif
                                    <a class="btn btn--primary m-1 print--btn"
                                       href={{ route('admin.order.generate-invoice', [$order['id']]) }}>
                                        <i class="tio-print mr-1"></i>
                                        <span>{{ translate('messages.print') }} {{ translate('messages.invoice') }}</span>
                                    </a>
                                </div>
                            </h1>
                            ...
                            @if ($order->schedule_at && ($order->scheduled || $subscription))
                                <span>
                                    ...
                                    <strong
                                        class="text-warning">{{ date('d M Y ' . config('timeformat'), strtotime($order['schedule_at'])) }}</strong>
                                </span>
                            @endif
                            ...
                            <div class="hs-unfold mt-2">
                                <button class="btn order--details-btn-sm btn--primary btn-outline-primary btn--sm"
                                        ...
                                        class="tio-poi-outlined"></i> <span
                                        class="ml-1">{{ translate('messages.show_locations_on_map') }}</span></button>
                        ...
                        @endif --}}
                            ...
                            <div class="order--note mt-3">
                                ...
                                @endif
                                @if($order['cancellation_note'] != null)
                                    <h6 class="my-2 ml-2">
                                        <strong class="text--title">{{ translate('messages.cancellation_note') }}
                                            :</strong>
                        ...
                        <div class="order-invoice-right">
                            <div
                                class="d-none d-sm-flex flex-wrap ml-auto align-items-center justify-content-end initial-39-1">
                                @if (!$subscription && !$editing && in_array($order->order_status, ['pending', 'confirmed', 'processing', 'accepted']))
                                    @if ($order->restaurant)
                                        <button class="btn bn--primary btn-outline-primary m-2 print--btn" type="button"
                                                onclick="edit_order()">
                                            <i class="tio-edit"></i>
                                            <span>{{ translate('messages.edit') }} {{ translate('messages.order') }}</span>
                                        </button>
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                <h6>
                                    @if ($order['transaction_reference'] == null)
                                        ...
                                        @if (isset($order->restaurant))
                                            <button class="btn btn-outline-primary btn--primary btn-sm add--referal"
                                                    data-toggle="modal"
                                        ...
                                        <div>
                                            <div class="input-group header-item">
                                                <select name="category" id="category"
                                                    ...
                                                    <option
                                                        value="">{{ translate('messages.all') }} {{ translate('messages.categories') }}
                                                    </option>
                                                            ...
                                                            <span
                                                                class="avatar-status avatar-lg-status avatar-status-dark"><i
                                                                    ...
                                                                    <div class="media-body">
                                                                        <div>
                                                                            <strong
                                                                                class="line--limit-1"> {{ $detail->food == null?'Not Found':$detail->food['name'] }}</strong>
                                                        ...
                                                        @if($detail->campaign == null)
                                                            <div class="avatar avatar-xl mr-3  cursor-pointer">
                                                                ...
                                                                @else
                                                                    <div class="avatar avatar-xl mr-3  cursor-pointer"
                                                                         ...
                                                                         title="{{ translate('messages.click_to_edit_this_item') }}">
                                                            <span
                                                                class="avatar-status avatar-lg-status avatar-status-dark">
                                                            <i class="tio-edit"></i></span>
                                                                    ...
                                                                    <div class="media-body">
                                                                        <div>
                                                                            <strong
                                                                                class="line--limit-1"> {{ $detail->campaign == null?'Not Found':$detail->campaign['name'] }}</strong>
                                                                ...
                                                                <strong>{{\App\CentralLogics\Helpers::format_currency( $value['optionPrice'])}}</strong>
                                                                            ...
                                                                            <h6>
                                                                                {{ $detail['quantity'] }}
                                                                                x {{ \App\CentralLogics\Helpers::format_currency($detail['price']) }}
                                                                            </h6>
                                                                        </div>
                                                                    </div>
                                                            </div>
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body pt-2">
                                ...
                                <ul class="delivery--information-single mt-3">
                                    ...
                                    @if (isset($order->refund->customer_note))
                                        <li>
                                            ...
                                            <span
                                                class="info">   {{ $order->refund->customer_note ?? 'No Note' }}</span>
                                        </li>
                                    @endif
                                    <hr class="w-100">
                                </ul>
                                ...
                                <div class="btn--container refund--btn">
                                    ...
                                    // 'refund_method'=> 'bank',
                                    'order_status' => 'refunded']) }}','{{ translate('messages.you_want_to_refund_this_order', ['amount' => $refund_amount . ' ' . \App\CentralLogics\Helpers::currency_code()]) }}', '{{ translate('messages.are_you_sure_want_to_refund') }}')">
                                                <i
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <div class="dropdown">
                                                    @if (isset($order->restaurant))
                                                        <button
                                                            class="form-control h--45px dropdown-toggle d-flex justify-content-between align-items-center"
                                                            type="button"
                                ...
                                <div class="card-body pt-2">
                                    <div class="mb-3 d-flex justify-content-between align-items-center">
                                        ...
                                        (isset($order->restaurant) && ($order->restaurant->restaurant_model == 'commission'
                                            ...
                                            <span class="ml-auto text--primary position-relative p-2 cursor-pointer"
                                    ...
                                    <a class="media align-items-center deco-none customer--information-single"
                                       href="{{ route('admin.customer.view', [$order->customer['id']]) }}">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span>
                                                        <strong
                                                            class="text--title font-semibold">{{ $order->customer->orders_count }}</strong>
                                                    ...
                                                    <div class="mt-2 d-flex w-100">
                                                                    <a target="_blank"
                                                                       href="http://maps.google.com/maps?z=12&t=m&q=loc:{{ $address['latitude'] }}+{{ $address['longitude'] }}">
                                                                        ...
                                                                        <span
                                                                            class="info pl-2">{{ $address['address'] }}</span>
                                                                    </a>
                                                                </div>
                                                @else
                                                    <div class="mt-2 d-flex w-100">
